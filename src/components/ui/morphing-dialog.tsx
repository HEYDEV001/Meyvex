...
const ITEMS: CardItem[] = [
  {
    ...
    image: "/service-performance-marketing.jpg",
    content: (
  ...
  },
  {
    ...
    image: "/service-social-media-marketing.jpg",
    content: (
      <div className="space-y-8 text-muted-foreground leading-relaxed">
        <ServiceHero
  ...
  },
  {
    ...
    image: "/service-content-marketing.jpg",
    content: (
      <div className="space-y-8 text-muted-foreground leading-relaxed">
        <ServiceHero
  ...
  },
  {
    ...
    image: "/service-shopify-development.jpg",
    content: (
      <div className="space-y-8 text-muted-foreground leading-relaxed">
        <ServiceHero
