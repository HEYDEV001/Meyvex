...
const MeyvexLogo = ({ className }: { className?: string }) => {
  return (
...
const footerLinks = [
  {
    ...
    links: [
      ...
      { name: "Retention Marketing", href: "/services" },
    ],
  },
  {
    title: "Company",
...
const SOCIAL_ICONS = [
  {
    name: "X",
    href: "https://x.com/meyvexmedia",
    viewBox: "-0.89 3.63 30.77 27.75",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/company/meyvex",
    viewBox: "45.75 2.75 28.5 28.5",
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/meyvexmedia",
    viewBox: "92.83 -0.17 34.33 34.26",
  ...
  return (
    <footer className="w-full bg-white relative overflow-hidden antialiased [font-synthesis:none]">
      ...
      <div className="relative w-full flex justify-center items-end pt-10 md:pt-16 lg:pt-32 pb-0 z-20">
        <h1 className="text-[80px] min-[400px]:text-[100px] min-[480px]:text-[120px] min-[640px]:text-[160px] md:text-[190px] lg:text-[260px] xl:text-[360px] font-semibold text-transparent [-webkit-text-stroke:1px_rgba(0,0,0,0.4)] leading-[0.75] select-none -mb-4 md:-mb-6 opacity-50">
          {companyName}
        </h1>
      </div>

      {/* Blue Panel Section */}
      <div className="relative w-full [--color-primary:#FC3712] bg-(--color-primary) z-10 min-h-[400px]">
        {/* Background Shader */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 lg:px-24 py-16 md:py-24 flex flex-col lg:flex-row justify-between gap-16 lg:gap-8">
          ...
          <div className="flex flex-col justify-between max-w-sm w-full">
            <div className="flex flex-col">
              {/* Logo SVG */}
              <MeyvexLogo className="text-white w-9 h-auto shrink-0 mb-2" />
            ...
            <div className="flex flex-col gap-3 mt-12 lg:mt-auto pt-8">
              {/* Social icons, each individually wired to its platform */}
